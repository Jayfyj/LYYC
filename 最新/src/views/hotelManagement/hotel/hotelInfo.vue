<template>
    <div>
        ...
        <div class="editNewFrom" :style="{'padding':'0 5%', 'padding-right':'15%'}">
            <el-col :span="24">
                <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="150px" class="demo-ruleForm">
                    <el-row>
                        ...
                        <el-col :span="12">
                            ...
                            <el-form-item label="酒店类型" prop="HOTEL_TYPE">
                                <el-select v-model="ruleForm.HOTEL_TYPE" placeholder="请选择内容" auto-complete="off">
                                    <el-option label="酒店" value="0"></el-option>
                                    <el-option label="度假村" value="1"></el-option>
                                    <el-option label="民宿" value="2"></el-option>
                                    <el-option label="客栈" value="3"></el-option>
                                    <el-option label="县级酒店" value="4"></el-option>
                                    <el-option label="青年旅舍" value="5"></el-option>
                                    <el-option label="主题酒店" value="6"></el-option>
                                    <el-option label="温泉酒店" value="7"></el-option>
                           ...
                           <!-- 5.选择框：酒店风格 -->
                            <el-form-item label="酒店风格" prop="HOTEL_STYLE">
                                <el-select v-model="ruleForm.HOTEL_STYLE" placeholder="请选择内容" auto-complete="off">
                                    <el-option label="复古" value="0"></el-option>
                                    <el-option label="现代" value="1"></el-option>
                        ...
                        <el-col :span="12">
                            ...
                            <el-form-item label="付款类型" prop="PRICE_TYPE">
                                <el-radio-group v-model="ruleForm.PRICE_TYPE" auto-complete="off">
                                    <el-radio class="radio" label="0">到付</el-radio>
                                    <el-radio class="radio" label="1">预付</el-radio>
                                </el-radio-group>
                            </el-form-item>
                        </el-col>
                        ...
                        <el-col :span="12">
                            ...
                            <el-form-item label="星级" prop="STARS">
                                <el-radio-group v-model="ruleForm.STARS" auto-complete="off">
                                    <el-radio class="radio" label="1">1星</el-radio>
                                    <el-radio class="radio" label="2">2星</el-radio>
                                    <el-radio class="radio" label="3">3星</el-radio>
                                    <el-radio class="radio" label="4">4星</el-radio>
                                    <el-radio class="radio" label="5">5星</el-radio>
                                </el-radio-group>
                            </el-form-item>
                        </el-col>
                        <el-col :span="12">
                        ...
                        <el-col :span="24">
                            <!-- 输入框：上传图片-->
                            <el-form-item label="酒店图片" prop="HOTEL_IMG" :style="{'z-index':imgDialogVisible?'-1':'1'}">
                                <el-upload
                                    action="#"
                                    :on-change="handlePicturChange"
                                    :on-remove="handleRemove"
                                    :on-preview="handlePictureCardPreview"
                                    :on-success ="handleSuccess"
                                    :file-list="ruleForm.HOTEL_IMG"
                                    list-type="picture-card"
                                    :auto-upload="false"
                                >
                                    <i class="el-icon-plus"></i>
                                </el-upload>
                                <el-dialog :visible.sync="imgDialogVisible" @click="imgDialogVisible = false">
                    ...
                    <el-col :span="17">
                        <el-form-item label="酒店简介" >
                            <!-- 富文本-->
                            <Edit v-model="ruleForm.HOTEL_DESC" :isClear="isClear" @change="change"/>
                        </el-form-item>
                    </el-col>
                    <el-col :span="24">
                        <!-- 单选框：是否可退订 -->
                        <el-form-item label="是否可退订" prop="CANCEL">
                            <el-radio-group v-model="ruleForm.CANCEL" auto-complete="off">
                                <el-radio class="radio" label="可退"></el-radio>
                                <el-radio class="radio" label="不可退"></el-radio>
                            </el-radio-group>
                        </el-form-item>
                    </el-col>
                    <el-col :span="24">
                        <!-- 单选框：退订是否需要审核 -->
                        <el-form-item label="退订是否需要审核" prop="CANCEL_EXAMINE">
                            <el-radio-group v-model="ruleForm.CANCEL_EXAMINE" auto-complete="off">
                                <el-radio class="radio" label="0">需要审核</el-radio>
                                <el-radio class="radio" label="1">不需要审核</el-radio>
                            </el-radio-group>
                        </el-form-item>
                    </el-col>
                    ...
                    <el-col :span="12">
                        <!-- 单选框：退订手续费 -->
                        <el-form-item label="退订手续费" prop="CANCEL_FEE_CHECK">
                            <el-radio-group v-model="ruleForm.CANCEL_FEE_CHECK" auto-complete="off">
                                <el-radio class="radio" label="0">固定金额</el-radio>
                                <el-radio class="radio" label="1">百分比</el-radio>
                                <el-radio class="radio" label="2">免手续费</el-radio>
                            </el-radio-group>
                        </el-form-item>
                    </el-col>
                    ...
                    <el-col :span="12">
                        <!-- 输入框：联系人邮箱-->
                        <el-form-item label="收取固定金额" prop="CANCEL_FEE" v-if="ruleForm.CANCEL_FEE_CHECK==0">
                            <el-input v-model="ruleForm.CANCEL_FEE" auto-complete="off" placeholder="请输入内容"></el-input>
                        </el-form-item>
                    </el-col>

                    <el-col :span="14">
                        <!-- 输入框：退订截止时间-->
                        <el-form-item label="退订截止时间" prop="CANCEL_TIME">
                            <span>入住日期</span>
                            <el-time-select
                                :style="{'width':'30%'}"
                                v-model="ruleForm.CANCEL_TIME"
                                :picker-options="{
                                    start: '18:00',
                                    step: '00:30',
                                    end: '24:00'
                     ...
                     <el-col :span="14">
                        <!-- 输入框：退订截止时间-->
                        <el-form-item label="活动形式" prop="CANCEL_DESC">
                            <el-input type="textarea" v-model="ruleForm.CANCEL_DESC"></el-input>
                        </el-form-item>
                    </el-col>
...
import Edit from "../../../wangEnduit/edit.vue"
  export default {
      ...
      return {
        ...
        ruleForm: {
            ...
            "HOTEL_IMG":[
                ...
                {
                    url: "https://ss0.bdstatic.com/70cFuHSh_Q1YnxGkpoWK1HF6hhy/it/u=32376829,3281010333&fm=26&gp=0.jpg"
                }


            ], //图片列表                待定参数
            "HOTEL_DESC":"<p>789789</p>",//酒店详情                待定参数                    
            "CANCEL":"",//是否退款                    待定参数
            "CANCEL_EXAMINE":"",//退款申请            待定参数
            "CANCEL_FEE_CHECK":"-1",//退款手续费       待定参数
            "CANCEL_FEE":"",//退款手续费              待定参数
            "CANCEL_TIME":"", //退房时间              待定参数
            "CANCEL_DESC":"", //退款说明              待定参数
        },
    ...
    methods: {
        ...
        change(txt){
            console.log(txt)
            // var txt1 = document.getElementById("editor");
            // console.log(txt1)
            this.ruleForm.HOTEL_DESC = txt
        },
        ...
        handlePicturChange(file, fileList) {
            console.log(file, fileList);
            this.ruleForm.HOTEL_IMG = fileList;
        },
